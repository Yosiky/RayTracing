...
{
    static t_intersec_ray   func[] = { intersect_ray_sphere , intersect_ray_plane, intersect_ray_cilinder};
...
{
    static t_get_normal func[] = { get_normal_sphere , get_normal_plane, intersect_ray_cilinder};
